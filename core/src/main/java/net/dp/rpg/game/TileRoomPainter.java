...
public final class TileRoomPainter
{
  ...
  public TileRoomPainter(TileTypeRegistry registry) {
  ...
  public TileRoom paint(TileFloorGenerator.RoomDraft draft, long seed) {
    ...
    properties.put(TileRoomShapes.SHAPE_PROPERTY, TileRoomShapes.encode(shape));
    ...
    return new TileRoom(draft.getId(), shape, draft.getOrigin(), draft.getDoors(), map);
  }
  ...
  private List<TileMapObject> markers(TileFloorGenerator.RoomDraft draft, RoomShape shape) {
